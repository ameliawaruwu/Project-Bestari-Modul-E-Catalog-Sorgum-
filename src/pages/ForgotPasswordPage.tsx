...
export const ForgotPasswordPage: React.FC<ForgotPasswordPageProps> = ({
  ...
  const inputCls =
    'w-full h-12 pl-12 pr-4 bg-[#F7F8F6] focus:bg-[#FFFFFF] border border-[#E0E0E0] rounded-xl text-xs sm:text-sm text-[#1B5E20] placeholder-[#555555]/60 focus:outline-none focus:border-[#2E7D32] focus:ring-1 focus:ring-[#2E7D32] transition-all font-medium';
  ...
  return (
    <div className="min-h-screen grid grid-cols-1 lg:grid-cols-12 bg-[#F7F8F6] text-[#1B5E20] font-['Plus_Jakarta_Sans']">
      ...
      <div className="lg:col-span-7 flex items-center justify-center p-6 sm:p-12">
        <div className="w-full max-w-md bg-[#FFFFFF] rounded-2xl p-8 border border-[#E0E0E0] shadow-2xs">
          {/* Back to Home */}
          <button
            onClick={onNavigateHome}
            className="group mb-6 inline-flex items-center gap-2 text-xs font-bold text-[#555555] hover:text-[#1B5E20] transition-all cursor-pointer"
          >
          ...
          {step === 1 ? (
            ...
            <form onSubmit={handleSendOtp} className="space-y-5">
              <div className="space-y-1.5">
                <label className="block text-xs font-bold text-[#555555] ml-0.5" htmlFor="fp-email">
                  Email
                </label>
            ...
            <form onSubmit={handleReset} className="space-y-5">
              {/* OTP */}
              <div className="space-y-1.5">
                <label className="block text-xs font-bold text-[#555555] ml-0.5" htmlFor="fp-otp">
                  Kode OTP
                </label>
                <div className="relative">
                  <span className="material-symbols-outlined absolute left-4 top-1/2 -translate-y-1/2 text-[#555555] text-lg select-none">
              ...
              {/* Password Baru */}
              <div className="space-y-1.5">
                <label className="block text-xs font-bold text-[#555555] ml-0.5" htmlFor="fp-newpass">
                  Password Baru
                </label>
                <div className="relative">
                  <span className="material-symbols-outlined absolute left-4 top-1/2 -translate-y-1/2 text-[#555555] text-lg select-none">
              ...
              {/* Konfirmasi Password */}
              <div className="space-y-1.5">
                <label className="block text-xs font-bold text-[#555555] ml-0.5" htmlFor="fp-confirm">
          ...
          <div className="mt-8 pt-6 border-t border-[#E0E0E0] text-center space-y-4">
            <p className="text-xs text-[#555555]">
              ...
              <button
                ...
                className="text-[#2E7D32] font-bold hover:underline transition-all cursor-pointer"
              >
            ...
            <button
              ...
              className="text-xs text-[#555555] font-semibold hover:text-[#2E7D32] transition-all cursor-pointer"
            >
              ← Kembali ke Login
            </button>
          </div>
